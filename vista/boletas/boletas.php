...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-12">
        <h2 class="page-header">
          <i class="fas fa-globe"></i> FOX S.A.
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <address>
          ...
          Phone: 928097155<br>
          Email: foxcamisetas@gmail.com<br>
          RUC: 20123456787
        </address>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        Para:
        <address>
          <strong><?=$data[0]['nomcliente'].' '.$data[0]['apecliente']?></strong><br>
          Direccion: <?=$data[0]['direccion']?><br>
          Nacionalidad: <?=$data[0]['nacionalidad']?><br>
          DNI: <?=$data[0]['dni']?><br>
          Celular:<?=$data[0]['telefono']?><br>
          Email: <?=$data[0]['email']?>
        </address>
      </div>
      <!-- /.col -->
      ...
      <div class="col-12 table-responsive">
        ...
        <?php 
            ...
            <tr>
                <td><?=$b['cantidad']?></td>
                <td>   
                    <b><?=$b['desccamiseta']?></b><br>
                    <?=$b['descseleccion']?>

                    <h5>Calidad: <code><?=$b['calidad']?></code> </h5>
                    <h5>Modelo: <code><?=$b['modelo']?></code> </h5>
                   
                </td>
                <td> <h5>Otros: <code><?=$b['producto']?></code> </h5></td>
    ...
    <div class="row">
      ...
      <div class="col-6">
        <p>
            <b>Son: </b> <?=$data[0]['NumerosALetras']?> Soles
        </p>
        <p class="lead">Gracias por su compra:</p>
        <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
          FOX S.A. tiene los mejores productos de Camisetas a su servicio.
        <br>
          Regrese pronto.
        </p>
