    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-right">
                ...
                <a href="?ctrl=CtrlTalla&accion=reporte&app=excel" class="btn btn-secondary">
                    <i class="fa fa-file-excel"></i> 
                    Descargar XLS
                </a>
                <a href="?ctrl=CtrlTalla&accion=reporte&app=word" class="btn btn-secondary">
    ...
    if (is_array($data))
        foreach ($data as $c) { ?>
            <tr>
                ...
                <td><?=$c["talla"]?></td>
                <td>
                <a data-id="<?=$c["idtalla"]?>" class="editar" href="#">
                    <i class="bi bi-pencil-square"></i> Editar </a>
                / 
                <a data-id="<?=$c["idtalla"]?>" data-nombre="<?=$c["talla"]?>" class="eliminar" href="#">
