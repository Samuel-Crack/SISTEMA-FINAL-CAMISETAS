    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-right">
                ...
                <a href="?ctrl=CtrlMarca&accion=reporte&app=excel" class="btn btn-secondary">
                    <i class="fa fa-file-excel"></i> 
                    Descargar XLS
                </a>
                <a href="?ctrl=CtrlMarca&accion=reporte&app=word" class="btn btn-secondary">
    ...
    if (is_array($data))
        foreach ($data as $c) { ?>
            <tr>
                ...
                <td><?=$c["marca"]?></td>
                <td>
                <a data-id="<?=$c["idmarca"]?>" class="editar" href="#">
                    <i class="bi bi-pencil-square"></i> Editar </a>
                / 
                <a data-id="<?=$c["idmarca"]?>" data-nombre="<?=$c["marca"]?>" class="eliminar" href="#">
