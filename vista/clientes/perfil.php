        ...
        <div class="row">
          <div class="col-md-3">
              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Último ingreso</b> <a class="float-right">23/11/2022</a>
                  </li>
                  <li class="list-group-item">
                    <b>Última Compra</b> <a class="float-right">24/11/2022</a>
                  </li>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <strong><i class="fas fa-book mr-1"></i> DNI</strong>

                <p class="text-muted">
                <h3 class="profile-username text-center"><?=$_SESSION['dni']?></h3>
                </p>
                ...
                <h3 class="profile-username text-center"><?=$_SESSION['direccion']?></h3>
                <hr>

                <strong><i class="fas fa-pencil-alt mr-1"></i> Numero Celular</strong>
                <h3 class="profile-username text-center"><?=$_SESSION['telefono']?></h3>
                <hr>

                <strong><i class="far fa-file-alt mr-1"></i> Correo Electronico</strong>

                <h3 class="profile-username text-center"><?=$_SESSION['email']?></h3>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        <label for="inputSkills" class="col-sm-2 col-form-label">Nacionalidad</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputSkills" placeholder="nacionalidad">
                        </div>
                      </div>
