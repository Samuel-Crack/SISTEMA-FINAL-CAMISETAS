    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-right">
                ...
                <a href="?ctrl=CtrlCalidad&accion=reporte&app=excel" class="btn btn-secondary">
                    <i class="fa fa-file-excel"></i> 
                    Descargar XLS
                </a>
                <a href="?ctrl=CtrlCalidad&accion=reporte&app=word" class="btn btn-secondary">
    ...
    if (is_array($data))
        foreach ($data as $c) { ?>
            <tr>
                ...
                <td><?=$c["calidad"]?></td>
                <td>
                <a data-id="<?=$c["idcalidad"]?>" class="editar" href="#">
                    <i class="bi bi-pencil-square"></i> Editar </a>
                / 
                <a data-id="<?=$c["idcalidad"]?>" data-nombre="<?=$c["calidad"]?>" class="eliminar" href="#">
